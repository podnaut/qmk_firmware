...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GMLAY1] = LAYOUT_dilemma(WASD_NUMBERS_3x10_4),
  [_GMLAY2] = LAYOUT_dilemma(WASD_CHAT_3x10_4),
  [_GMLAY3] = LAYOUT_dilemma(STARCRAFT_3x10_4),
  [_GMLAY4] = LAYOUT_dilemma(CONTROL_GROUP_1_3x10_4),
  [_GMLAY5] = LAYOUT_dilemma(CONTROL_GROUP_2_3x10_4),
